        ...
        projects: [
          {
            ...
            workedOn: "2025-01-06T00:00:00.000Z",
            role: "Lead developer",
            tags: ["Next.js", "TypeScript", "Prisma", "Design Systems"],
            body: "Rebuilt the entire stack to support live patching, admin workflows, and custom CRT UI primitives. The layout flexes down to handheld devices while keeping the neon command-center feel.",
            images: [
              { url: "/images/gallery/kon.jpg", caption: "CRT-inspired window manager" },
              { url: "/images/gallery/nichijou.jpg", caption: "Admin tools for realtime edits" },
            ],
            links: [
              { type: "website", label: "Live Site", url: "https://jamescrovo.com" },
              { type: "github", label: "Source", url: "https://github.com/jamescrovo/blog" },
            ],
          },
          {
            id: "halo-lab",
            ...
            workedOn: "2024-08-15T00:00:00.000Z",
            role: "Creative technologist",
            tags: ["WebGL", "Three.js", "TouchDesigner"],
            body: "Built a shader toolkit that listens to live synth inputs, then paints volumetric streaks that feel like hovering neon. Everything syncs across a fleet of displays.",
            images: [
              { url: "/images/gallery/japan.jpg", caption: "Light halos cascading across displays" },
            ],
            links: [
              { type: "video", label: "Showreel", url: "https://jamescrovo.com/projects/halo-lab" },
            ],
          },
          {
            id: "signal-kit",
            ...
            workedOn: "2023-04-12T00:00:00.000Z",
            role: "Product engineer",
            tags: ["React", "Remix", "WebSockets", "D3.js"],
            body: "Designed a modular dashboard layer with live widgets, remote control, and quick prototyping scripts. Teams can plug in any stream and get a cinematic HUD instantly.",
            images: [
              { url: "/images/gallery/cookies.jpg", caption: "Signal Kit interface" },
            ],
            links: [
              { type: "github", label: "GitHub", url: "https://github.com/jamescrovo/signal-kit" },
              { type: "docs", label: "Docs", url: "https://signal-kit.dev/docs" },
            ],
          },
        ],
      },
